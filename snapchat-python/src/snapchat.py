...
class Snapchat(object):
    ...
    def __init__(self, username=None, password=None):
        ...
        self.cipher = AES.new(str(Snapchat.BLOB_ENCRYPTION_KEY).encode("utf-8"), AES.MODE_ECB)
    ...
    def get_stories(self):
        ...
        if isinstance(result, dict):
            print
            "Story Data Request Successful\n"
            return result
        else:
            print
            "Story Data Request Failed"
            print
            "With Error:\n"
            print
            result
    ...
    def _post(self, endpoint, data, auth_token, media_data=None):
        ...
        if r.status_code != 200 and r.status_code != 202:
            ...
            print
            "Snapcht Server Response:", r.status_code
            print
            "With Error:"
            print
            r.content
    ...
    def _hash(self, auth_token, timestamp):
        ...
        # Hash the values.
        hash1 = hashlib.sha256(first.encode('utf-8')).hexdigest()
        hash2 = hashlib.sha256(second.encode('utf-8')).hexdigest()
    ...
    def _decrypt_media(self, data):
        if not self._is_media(data):
            ...
            if not self._is_media(data):
                ...
                print
                "Media Decryption May Have Failed"
